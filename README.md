...
> ⚠️ **项目状态：早期开发（Step 44 fsync 已验收；下一步 Step 45 KERNEL-AOPS；IPC ABI v21；cache format v4）。**
>
...
| **4. 内核拥有的 NVMe 缓存** | 内核直访本地块设备；命中绕过 Rust daemon | 🚧 Step 29–44 已验收；下一步 Step 45 KERNEL-AOPS（ABI v21 / format v4） |
